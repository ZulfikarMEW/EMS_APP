...
import { MasterSector } from "./MasterSector";
...
export class SectorComponent implements OnInit {
  ...
  openEditModal(dataModal: any, item: MasterSector) {
    this.form.reset();
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.masterService.postMasterData(11, a).subscribe(
        (res) => {
          console.log(res);
