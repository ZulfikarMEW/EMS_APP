...
import { MasterJobDegree } from "./MasterJobDegree";

@Component({
  selector: "app-job-degree",
  templateUrl: "./job-degree.component.html",
  styleUrls: ["./job-degree.component.scss"],
})
export class JobDegreeComponent implements OnInit {
  ...
  openEditModal(dataModal: any, item: MasterJobDegree) {
    this.form.reset();
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.masterService.postMasterData(1, a).subscribe(
        (res) => {
          console.log(res);
